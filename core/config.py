...
VIDEO_RESOLUTION_PRESETS = {
    ...
    "portrait_hd": {"width": 1080, "height": 1920, "label": "竖屏 Full HD 9:16"},
    "landscape_hd": {"width": 1920, "height": 1080, "label": "横屏 Full HD 16:9"},
}
...
DURATION_FRAME_MAP = {
    ...
    10: (153, 15),   # 10.2s — 153 = 8*19+1 ✅
    12: (177, 15),   # 11.8s — 177 = 8*22+1 ✅
    15: (225, 15),   # 15.0s — 225 = 8*28+1 ✅
}
